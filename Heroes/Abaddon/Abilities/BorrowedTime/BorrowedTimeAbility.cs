...
namespace DoTaria.Heroes.Abaddon.Abilities.BorrowedTime
{
    public sealed class BorrowedTimeAbility : AbilityDefinition
    {
        ...
        public BorrowedTimeAbility() : base(UNLOCALIZED_NAME, "Borrowed Time", AbilityType.Active, AbilityTargetType.NoTarget, AbilityTargetFaction.Self, DamageType.None, AbilitySlot.Ultimate, 6, 3)
        {
        }
